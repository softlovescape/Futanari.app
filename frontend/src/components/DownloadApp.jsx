...
const DownloadApp = () => {
  ...
  useEffect(() => {
    // Load Meta Pixel for download-app page
    if (!window.fbq) {
      ...
      window.fbq('init', '1479802899806454');
    }
    
    // Track PageView for download-app page
    ...
    if (!document.querySelector('img[src*="facebook.com/tr"]')) {
      ...
      noscriptImg.src = 'https://www.facebook.com/tr?id=1479802899806454&ev=PageView&noscript=1';
