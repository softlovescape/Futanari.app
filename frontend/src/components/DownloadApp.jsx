        ...
        <div className="max-w-6xl mx-auto px-2 sm:px-4 py-4 sm:py-8">
          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex gap-2 sm:gap-4 overflow-x-auto pb-4">
              <img src="/Screenshot 2025-08-18 at 8.53.55ΓÇ»AM-Photoroom.png" alt="Screenshot 1" className="w-40 h-64 sm:w-48 sm:h-80 lg:w-64 lg:h-[500px] object-cover rounded-xl sm:rounded-2xl shadow-md border border-gray-200 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300" onClick={() => openModal("/Screenshot 2025-08-18 at 8.53.55ΓÇ»AM-Photoroom.png", "Screenshot 1")} />
              <img src="/Screenshot 2025-08-18 at 8.54.41ΓÇ»AM-Photoroom.png" alt="Screenshot 2" className="w-40 h-64 sm:w-48 sm:h-80 lg:w-64 lg:h-[500px] object-cover rounded-xl sm:rounded-2xl shadow-md border border-gray-200 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300" onClick={() => openModal("/Screenshot 2025-08-18 at 8.54.41ΓÇ»AM-Photoroom.png", "Screenshot 2")} />
              <img src="/Screenshot 2025-08-18 at 8.55.12ΓÇ»AM-Photoroom.png" alt="Screenshot 3" className="w-40 h-64 sm:w-48 sm:h-80 lg:w-64 lg:h-[500px] object-cover rounded-xl sm:rounded-2xl shadow-md border border-gray-200 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300" onClick={() => openModal("/Screenshot 2025-08-18 at 8.55.12ΓÇ»AM-Photoroom.png", "Screenshot 3")} />
              <img src="/Screenshot 2025-08-18 at 8.55.37ΓÇ»AM-Photoroom.png" alt="Screenshot 4" className="w-40 h-64 sm:w-48 sm:h-80 lg:w-64 lg:h-[500px] object-cover rounded-xl sm:rounded-2xl shadow-md border border-gray-200 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300" onClick={() => openModal("/Screenshot 2025-08-18 at 8.55.37ΓÇ»AM-Photoroom.png", "Screenshot 4")} />
              <img src="/Screenshot 2025-08-18 at 8.59.06ΓÇ»AM-Photoroom.png" alt="Screenshot 5" className="w-40 h-64 sm:w-48 sm:h-80 lg:w-64 lg:h-[500px] object-cover rounded-xl sm:rounded-2xl shadow-md border border-gray-200 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300" onClick={() => openModal("/Screenshot 2025-08-18 at 8.59.06ΓÇ»AM-Photoroom.png", "Screenshot 5")} />
            </div>
          </div>
